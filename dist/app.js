...
const staticSchemaPaths = Object.keys(massageKeywordHeadings).concat(['/services/prenatal-massage/', '/services/prenatal-massage', '/insurance-massage/', '/insurance-massage']);
if ((window.location.pathname.startsWith('/services/') || window.location.pathname === '/insurance-massage/') && !staticSchemaPaths.includes(window.location.pathname)) {
  const serviceSchema = {
...
const staticallyExpandedPages = ['/services/deep-tissue-massage/', '/services/swedish-massage/', '/services/couples-massage/', '/services/ashiatsu-massage/', '/services/four-hands-massage/', '/services/sport-massage/', '/services/foot-reflexology/'];
const massagePage = staticallyExpandedPages.includes(massagePath) ? null : massageContent[massagePath];
if (massagePage && document.querySelector('main')) {
  ...
  details.innerHTML = `<div class="service-details-heading"><p class="eyebrow">A little more about your session</p><h2>Care shaped around how you want to feel.</h2><p>Every massage at Fall Health Spa begins with a conversation, not a template.</p></div>
    ...
    <details class="service-faq"><summary>Can I choose the pressure?</summary><p>Yes. Tell your therapist what feels comfortable before and during the session. Pressure and focus can be adjusted around your preferences.</p></details>
    <details class="service-faq"><summary>How do I choose a session length?</summary><p>Consider whether you want focused work on one area or a more complete session. Contact Fall Health Spa if you would like help choosing.</p></details>
    <details class="service-faq"><summary>How do I book this massage in Bellevue?</summary><p>Use the Book online button to view current availability, or call (425) 454-7177 with questions before scheduling.</p></details>`;
